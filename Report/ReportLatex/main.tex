...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=8.7mm, height=8.7mm]{Image/bachkhoa_logo.png}}
   \end{picture}&
	\begin{tabular}{l}
		\textbf{\bf \ttfamily\color{blue}Trường Đại học Bách khoa - ĐHQG–HCM}
             \\[-1.4ex] \textbf{\bf \ttfamily\color{blue} Khoa Điện - Điện tử} 
	\end{tabular} 
 \end{tabular}
}
\fancyhead[R]{
 \begin{tabular}{r}
    % \textbf{\bf \ttfamily \color{blue} Nhóm 8}
\end{tabular} 
}
\fancyfoot{} % clear all footer fields
\fancyfoot[L]{\footnotesize \ttfamily \textcolor{black}{Báo cáo Bài tập lớn môn học Hệ thống điều khiển nhúng (EE3067)}}
\fancyfoot[R]{\footnotesize \ttfamily \textcolor{black}{Trang {\thepage}/{\hypersetup{linkcolor=black}\pageref{LastPage}}}}
...
\tableofcontents
\pagebreak
\input{chapter/1_TongQuanDeTai}
\input{chapter/2_CoSoLyThuyet}
\input{chapter/3_ThietKeHeThong}
\input{chapter/4_KetQuaThucHien}
\input{chapter/5_KetLuanVaHuongPhatTrien}
\input{chapter/6_References}
\end{document}